...
describe('server.js', function () {
    describe('getServerInfo()', function () {
        it('should parse RPL_YOURHOST', function (done) {
            ...
            stream.write(':vulcanus.kerat.net 002 foo :Your host is vulcanus.kerat.net, running version InspIRCd-2.0\r\n');
            process.nextTick(function () {
                var svrInfo = client.getServerInfo();
                svrInfo.servername.should.equal('vulcanus.kerat.net');
        ...
        it('should parse RPL_CREATED', function (done) {
            ...
            stream.write(':vulcanus.kerat.net 003 foo :This server was created 16:48:26 Jan 20 2014\r\n');
            process.nextTick(function () {
                var svrInfo = client.getServerInfo();
        ...
        it('should parse RPL_ISUPPORT', function (done) {
            ...
            stream.write(':vulcanus.kerat.net 005 foo AWAYLEN=200 CALLERID=g CASEMAPPING=rfc1459 CHANMODES=beg,k,FJLfjl,ABMRScimnprstz CHANNELLEN=64 CHANTYPES=# CHARSET=ascii ELIST=MU EXCEPTS=e EXTBAN=,ABRSUcpz FNC KICKLEN=255 MAP :are supported by this server\r\n');
            stream.write(':vulcanus.kerat.net 005 foo MAXBANS=60 MAXCHANNELS=20 MAXPARA=32 MAXTARGETS=20 MODES=20 NAMESX NETWORK=KeratNet NICKLEN=31 OPERLOG PREFIX=(Yqaohv)!~&@%+ SSL=[2a03:4000:2:109::4:36]:6697 STARTTLS STATUSMSG=!~&@%+ :are supported by this server\r\n');
            stream.write(':vulcanus.kerat.net 005 foo TOPICLEN=307 UHNAMES VBANLIST WALLCHOPS WALLVOICES :are supported by this server\r\n');
            process.nextTick(function () {
                var svrInfo = client.getServerInfo();
                ...
                svrInfo.supports.NETWORK.should.equal('KeratNet');
